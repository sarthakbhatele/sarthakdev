        ...
        {theme === 'pacman' ? (
          ...
          <>
            ...
            <span style={{ fontFamily: 'var(--font-space),sans-serif', fontStyle: 'italic', fontSize: '0.7rem', color: '#769656', lineHeight: 1.4 }}>
              <strong>{q.label} · </strong>{OPENINGS[q.openingIdx].subtitle}
            </span>
          </>
        )}
      </motion.div>
...
export default function Skills() {
  ...
  const subtitle = theme === 'chess'
    ? 'Precision. Always.'
    : 'Grab \'em before the ghost does.'
  ...
  return (
    ...
    >
      ...
      <motion.p
        ...
        style={theme === 'chess'
          ? { fontFamily: 'var(--font-playfair),serif', fontStyle: 'italic', fontSize: '1.1rem', color: '#769656', marginTop: '-1.5rem', marginBottom: '2.5rem' }
          : { fontFamily: 'var(--font-space),sans-serif', fontSize: '0.85rem', color: '#A0A0A0', marginTop: '-1.5rem', marginBottom: '2.5rem', letterSpacing: '0.05em' }
        }
      >
        {subtitle}
      </motion.p>
